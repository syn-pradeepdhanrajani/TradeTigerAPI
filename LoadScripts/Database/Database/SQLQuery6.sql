...
21226, 21670, 23126, 24959, 25464, 25681, 25682, 27000, 27279, 27712, 28799, 28800, 28801, 32003, 32431, 32800, 33207)
...
select * from [dbo].[Script]
where ScriptName = 'BATAINDIA' or ScriptName = 'BAJAJ-AUTO'
