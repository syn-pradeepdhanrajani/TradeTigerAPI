...
namespace TradeTigerAPI
{
    public class CStructures
    {
        ...
        /// <summary>
        /// New Structure: This is done by Rahul. Date:30/10/2010 (Size Change:38-40)
        /// MESSAGEHEADER    (Size :=  40) (Location := 0 = 39)
        /// </summary>
        public struct MessageHeader : IStruct
        {
            ...
            /// <summary>
            /// CHAR Reserved[4]  :Size 4  (Location :0=3)
            /// </summary>
            ...
            /// </summary>
            public string Prop01Reserved
            {
                get { return new string(Reserved); }
                set { Reserved = CUtility.GetPreciseArrayForString(value.ToUpper(), Reserved.Length); }
            }           

            /// <summary>
            /// LONG LogTime  :Size 4  (Location :4=7)
            /// </summary>
            ...
            /// <summary>
            /// CHAR AlphaChar[2]  :Size 2 (Location :8=9)
            /// </summary>
            ...
            /// <summary>
            /// SHORT TransactionCode   :Size 2  (Location:10=11)
            /// </summary>
            ...
            /// <summary>
            /// SHORT ErrorCode   :Size 2  (Location:12=13)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Timestamp [8]  :Size 8(Location:14=21)
            /// </summary>
            ...
            /// <summary>
            /// CHAR TimeStamp1 [8]  :Size 8(Location:22=29)
            /// /// </summary>
            ...
            /// <summary>
            /// CHAR TimeStamp2 [8]  :Size 8(Location:30=37)
            /// /// </summary>
            ...
            /// <summary>
            /// SHORT MessageLength  :Size 2(Location:38=39)
            /// /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                {
                    // Reverse the byte
                    byte[] Exchguserid = new byte[Reserved.Length];
                    Exchguserid = CUtility.ConvertCharFrom16to8bit(Reserved);             
                    ...
                    Buffer.BlockCopy(Exchguserid, 0, HeadStruct, 0, 4);                   
                    Buffer.BlockCopy(ExchgLogTime, 0, HeadStruct, 4, 4);
                    Buffer.BlockCopy(ExchgAlphaChar, 0, HeadStruct, 8, 2);
                    Buffer.BlockCopy(ExchgTransactionCode, 0, HeadStruct, 10, 2);
                    Buffer.BlockCopy(ExchgErrorCode, 0, HeadStruct, 12, 2);
                    Buffer.BlockCopy(ExchgTimeStamp, 0, HeadStruct, 14, 8);
                    Buffer.BlockCopy(ExchgTimeStamp1, 0, HeadStruct, 22, 8);
                    Buffer.BlockCopy(ExchgTimeStamp2, 0, HeadStruct, 30, 8);
                    Buffer.BlockCopy(ExchgMessageLength, 0, HeadStruct, 38, 2);
                    return HeadStruct;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                try
                {
                    Prop01Reserved = Encoding.ASCII.GetString(ByteStructure, 0, 4);             
                    Prop03LogTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 4));
                    Prop04AlphaChar = Encoding.ASCII.GetString(ByteStructure, 8, 2);
                    Prop05TransactionCode = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 10));
                    Prop06ErrorCode = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 12));
                    Prop07TimeStamp = Encoding.ASCII.GetString(ByteStructure, 14, 8);
                    Prop08TimeStamp1 = Encoding.ASCII.GetString(ByteStructure, 22, 8);
                    Prop09TimeStamp2 = Encoding.ASCII.GetString(ByteStructure, 30, 8);
                    Prop10MessageLength = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 38));
                }
                catch (Exception ex)
                {
            ...
            public override string ToString()
            {
                try
                {
                    return (Prop01Reserved.ToString() + CConstants.Seperator +                       
        ...
        /// <summary>
        /// New Structure: Added by Rahul Date 30/10/2010  (Size Change:180-182)
        /// MSERRORRESPONSE (Size:182) (Location:0=181)
        /// </summary>
        public struct ErrorResponse : IStruct
        {
             ...
             * ==================================
             * Total                         182        Tap Header(22)+Error Response(182)=204
             * ==================================
             * */
            /// <summary>
            /// MESSAGEHEADER  Size(40) Location:0=39
            ...
            /// <summary>
            /// CHAR Key [14] :Size (14) (Location:40=53)
            /// </summary>
            public char[] ckey;
            /// <summary>
            /// CHAR Key [14] :Size (14) (Location:40=53)
            ...
            /// <summary>
            /// CHAR ErrorMessage [128] :Size (128) (Location:54=181)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                try
                {
                    ...
                    Errorresponse = CUtility.PutBytesInPosition(strHeader.StructToByte(), 0, 40, Errorresponse);
                    Errorresponse = CUtility.PutBytesInPosition(CUtility.ConvertCharFrom16to8bit(ckey), 40, 14, Errorresponse);
                    Errorresponse = CUtility.PutBytesInPosition(CUtility.ConvertCharFrom16to8bit(cErrorMessage), 54, 128, Errorresponse);
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                try
                {
                    ...
                    Prop02Key = Encoding.ASCII.GetString(ByteStructure, 40, 14);
                    Prop03ErrorMessage = Encoding.ASCII.GetString(ByteStructure, 54, 128);
                }
                catch (Exception ex)
                {
        ...
        #region Sign On
        /// <summary>
        /// New Structure : Done by Rahul Date:30/10/2010  (Size Changed:210-214)
        /// SIGNON Size(214) Location(0=213)
        /// </summary>
        public struct SignOn : IStruct
        {

            /*
             *  Message header                          40      40
             *  SHORT UserId                             4      44
                CHAR Password [8]                        8      52
                CHAR NewPassword [8]                     8      60
                CHAR TraderName [26]                    26      86
                LONG LastPasswordChangeDate              4      90
                CHAR BrokerId [5]                        5      95
                CHAR Reserved                            1      96
                SHORT BranchId                           2      98
                LONG VersionNumber                       4      102
                LONG Batch2StartTime                     4      106
                CHAR HostSwitchContext                   1      107
                CHAR Colour [50]                        50      157
                CHAR Reserved                            1      158
                SHORT UserType                           2      160
                DOUBLE SequenceNumber                    8      168
                CHAR WsClassName [14]                   14      182
                CHAR BrokerStatus                        1      183
                CHAR ShowIndex                           1      184
                struct STBROKERELIGIBILITYPERMKT         2      186
                SHORT MemberType                         2      188
                CHAR ClearingStatus                      1      189
                CHAR BrokerName [25]                    25      214              
             * ================================================
             * Total                                    214
             * ================================================
             */
            ...
            /// <summary>
            /// SHORT UserId : Size(4) (Location=40=43)
            /// </summary>
            Int32 iUserId;
            /// <summary>
            /// SHORT UserId : Size(4) (Location=40=43)
            /// </summary>
            public Int32 Prop02UserId
            {
                get { return iUserId; }
                set { iUserId = value; }
            }
            ...
            /// <summary>
            /// CHAR Password [8] :Size(8) Location:44=51
            /// </summary>
            ...
            /// <summary>
            /// CHAR NewPassword [8] : Size(8) Location:52=59
            /// </summary>
            ...
            /// <summary>
            /// CHAR TraderName [26] :Size(26) Location(60=85)
            /// </summary>
            Char[] cTraderName;
            /// <summary>
            /// CHAR TraderName [26] :Size(26) Location(60=85)
            ...
            /// <summary>
            /// LONG LastPasswordChangeDate :size(4) Location:86=89
            /// </summary>
            ...
            /// <summary>
            /// CHAR BrokerId [5] : size(5) Location(90=94)
            /// </summary>
            Char[] cBrokerId;
            /// <summary>
            /// CHAR BrokerId [5] : size(5) Location(90=94)
            ...
            /// <summary>
            /// CHAR Reserved :size(1)  Location(95=96)
            /// </summary>
            Char[] cReserved;
            /// <summary>
            /// CHAR Reserved :size(1)  Location(95=96)
            ...
            /// <summary>
            /// SHORT BranchId :Size(2) Location(96=97)
            /// </summary>
            Int16 iBranchId;
            /// <summary>
            /// SHORT BranchId :Size(2) Location(96=97)
            ...
            /// <summary>
            /// LONG VersionNumber : Size(4) Location(98=101)
            /// </summary>
            ...
            /// <summary>
            /// LONG Batch2StartTime :Size(4) Location:102=105
            /// </summary>
            ...
            /// <summary>
            /// CHAR HostSwitchContext : size(1) Location(106)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Colour [50] : Size(50) Location(107=156)
            /// </summary>
            public Char[] cColour;
            /// <summary>
            /// CHAR Colour [50] : Size(50) Location(107=156)
            ...
            /// <summary>
            /// CHAR Reserved : Size(1) Location(157)
            /// </summary>
            Char[] cReserve1;
            /// <summary>
            /// CHAR Reserved : Size(1) Location(157)
            ...
            /// <summary>
            /// SHORT UserType :size(2) Location(158=159))
            /// • ‘0’ denotes Dealer
            ...
            /// <summary>
            /// DOUBLE SequenceNumber :Size(8) Location(160=167)
            /// </summary>
            public Double iSequenceNumber;
            /// <summary>
            /// SHORT UserType :size(2) Location(160=167))
            /// </summary>
            ...
            /// <summary>
            /// CHAR WsClassName [14] :Size(14) Location(168=181)
            /// </summary>
            Char[] cWSClassName;
            /// <summary>
            /// CHAR WsClassName [14] :Size(14) Location(168=181)
            ...
            /// <summary>
            /// CHAR BrokerStatus :size(1) Location(182)
            /// S=Suspended 
            /// A=Active
            /// D=DeActive
            /// C=Close out
            ...
            /// <summary>
            /// CHAR ShowIndex : Size(1) Location(183)
            /// </summary>
            Char[] cShowIndex;
            /// <summary>
            /// CHAR ShowIndex : Size(1) Location(183)
            ...
            /// <summary>
            ///  BROKERELIGIBILITYPERMKT : Size(2) Location(184=185)
            /// </summary>
            ...
            /// <summary>
            /// SHORT MemberType : Size(2) Location(186=187)
            /// 1= Trading Member
            ...
            /// <summary>
            /// CHAR ClearingStatus :Size(1) Location(188)
            /// A=Active
            /// S=Suspended
            /// D=DeActivated
            /// </summary>
            ...
            /// <summary>
            /// CHAR BrokerName [25]  size(25) Location(189=213)
            /// </summary>
            Char[] cBrokerName;
            /// <summary>
            /// CHAR BrokerName [25]  size(25) Location(189=213)
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, LoginRequest, 0, 40);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iUserId), 0, LoginRequest, 40, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cPassword), 0, LoginRequest, 44, 8);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cNewPassword), 0, LoginRequest, 52, 8);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cTraderName), 0, LoginRequest, 60, 26);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastPwdChangeDate), 0, LoginRequest, 86, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBrokerId), 0, LoginRequest, 90, 5);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserved), 0, LoginRequest, 95, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBranchId), 0, LoginRequest, 96, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iVersionNumber), 0, LoginRequest, 98, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBatchToStartTime), 0, LoginRequest, 102, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cHostSwitchContext), 0, LoginRequest, 106, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cColour), 0, LoginRequest, 107, 50);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve1), 0, LoginRequest, 157, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iUserType), 0, LoginRequest, 158, 2);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iSequenceNumber), 0, LoginRequest, 160, 8);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cWSClassName), 0, LoginRequest, 168, 14);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBrokerStatus), 0, LoginRequest, 182, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cShowIndex), 0, LoginRequest, 183, 1);
                    Buffer.BlockCopy(strEligibilty.StructToByte(), 0, LoginRequest, 184, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iMemberType), 0, LoginRequest, 186, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cClearingStatus), 0, LoginRequest, 188, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBrokerName), 0, LoginRequest, 189, 25);
                    return LoginRequest;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02UserId = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 40));
                    Prop03Password = Encoding.ASCII.GetString(ByteStructure, 44, 8);
                    Prop04NewPassword = Encoding.ASCII.GetString(ByteStructure, 52, 8);
                    Prop05Tradername = Encoding.ASCII.GetString(ByteStructure, 60, 26);
                    Prop06LastPwdChangeDate = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 86));
                    Prop07Brokerid = Encoding.ASCII.GetString(ByteStructure, 90, 5);
                    Prop08Reserved = Encoding.ASCII.GetString(ByteStructure, 95, 1);
                    Prop09Branchid = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 96));
                    Prop10VersionNumber = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 98));
                    Prop11BatchToStartTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 102));
                    Prop12HostSwitchContext = Encoding.ASCII.GetString(ByteStructure, 106, 1);
                    Prop13Colour = Encoding.ASCII.GetString(ByteStructure, 107, 50);
                    Prop14Reserved1 = Encoding.ASCII.GetString(ByteStructure, 157, 1);
                    Prop15Usertype = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 158));
                    Prop16Sequenceno = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 160, 8));// IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 156));
                    Prop17WSClassName = Encoding.ASCII.GetString(ByteStructure, 168, 14);
                    Prop18Brokerstatus = Encoding.ASCII.GetString(ByteStructure, 182, 1);
                    Prop19ShowIndex = Encoding.ASCII.GetString(ByteStructure, 183, 1);
                    Prop20Eligibilty.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 184, 2));
                    Prop21MemberType = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 186));
                    Prop22ClearStatus = Encoding.ASCII.GetString(ByteStructure, 188, 1);
                    Prop23BrokerName = Encoding.ASCII.GetString(ByteStructure, 189, 25);
                }
                catch (Exception ex)
                {
        ...
        #region System Info
        /// <summary>
        /// New Structure : Done by Rahul Date:30/10/2010  (Size:42-44)
        ...
        public struct SystemInfoRequest : IStruct
        {
             ...
             * */
            /// <summary>
            /// Message Header : size(40) Location(0-39)
            /// </summary>
            public MessageHeader strHeader;
            /// <summary>
            /// Message Header : size(40) Location(0-39)
            ...
            /// <summary>
            /// Message Header : size(4) Location(40-43)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                Buffer.BlockCopy(Prop01Header.StructToByte(), 0, systemInfo, 0, 40);
                Buffer.BlockCopy(CUtility.GetBytesFromNumbers(Prop02LastPortfolioUpd), 0, systemInfo, 40, 4);
                return systemInfo;
            ...
            {
                Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                Prop02LastPortfolioUpd = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 40));
            }
        ...
        {
            /*
             * Messageheader                    40  40  0
             * Marketstatus                     8   48  40
             * ExMarketstatus                   8   56  48
             * PLMarketstatus                   8   64  56
             * UpdatePortfolio                  1   65  64
             * MarketIndex                      4   69  65
             * DefaultSettlementPeriod          2   71  69  NormalMkt
             * DefaultSettlementPeriod          2   73  71  spot
             * DefaultSettlementPeriod          2   75  73  Auction
             * CompetitorPeriod                 2   77  75
             * SolicitorPeriod                  2   79  77
             * WarningPercent                   2   81  79
             * VolumeFreezePercent              2   83  81
             * SnapQuoteTime                    2   85  83
             * Reserved                         2   87  85
             * BoardLotQuantity                 4   91  87
             * TickSize                         4   95  91
             * MaximumGtcDays                   2   97  95
             * Stockeligibleindicator           2   99  97
             * DisclosedQuantityPercentAllowed  2   101 99
             * RiskFreeInterestRate             4   105 101
             */
            ...
            /// <summary>
            /// Marketstatus : Size(8) Location(40-47) 
            /// </summary>
            public MarketStatus strMarketStatus;
            /// <summary>
            /// Property Marketstatus : Size(8)*3 Location(40-63) 
            /// </summary>
            ...
            /// <summary>
            /// CHAR UpdatePortfolio :size(1) Location(64)
            /// </summary>
            ...
            /// <summary>
            /// LONG MarketIndex : size(4) Location(65-68) 
            /// </summary>
            ...
            /// <summary>
            /// SHORT DefaultSettlementPeriod(Normal) : size (2) Location(69-70)
            /// </summary>
            ...
            /// <summary>
            /// SHORT DefaultSettlementPeriod (Spot): size(2) Location(71-72)
            /// </summary>
            ...
            /// <summary>
            /// SHORT DefaultSettlementPeriod (Auction) :size(2) Location(73-74)
            /// </summary>
            ...
            /// <summary>
            /// SHORT CompetitorPeriod :size(2) Location(75-76)
            /// </summary>
            ...
            /// <summary>
            /// SHORT SolicitorPeriod :Size(2) Location(77-78)
            /// </summary>
            ...
            /// <summary>
            /// SHORT WarningPercent : Size(2) Location(79-80)
            /// </summary>
            ...
            /// <summary>
            /// SHORT VolumeFreezePercent: size(2) Location(81-82)
            /// </summary>
            ...
            /// <summary>
            /// SHORT SnapQuoteTime :size(2) Location(83-84)
            /// </summary>
            ...
            /// <summary>
            /// SHORT Reserved :size(2) Loaction(85-86)
            /// </summary>
            ...
            /// <summary>
            /// LONG BoardLotQuantity :size(4) Loaction(87-90)
            /// </summary>
            ...
            /// <summary>
            /// LONG TickSize : Size(4) Location (91-94)
            /// </summary>
            ...
            /// <summary>
            ///  SHORT MaximumGtcDays : Size(2) Location(95-96)
            /// </summary>
            ...
            /// <summary>
            /// Struct STSTOCKELIGIBLEINDICATORS : size(2) Location (97-98)
            /// </summary>
            ...
            /// <summary>
            /// SHORT DisclosedQuantityPercentAllowed : size(2) Location(99-100)
            /// </summary>
            ...
            /// <summary>
            /// LONG RiskFreeInterestRate : Size(4) Location(101-104)
            /// </summary>
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02InfoMarketResponse.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 40, 8));
                    Prop02aInfoMarketResponse.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 48, 8));
                    Prop02bnfoMarketResponse.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 56, 8));
                    Prop03UpdatePortfolio = Encoding.ASCII.GetString(ByteStructure, 64, 1);
                    Prop04MarketIndex = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 65));
                    Prop05SettlementNormal = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 69));
                    Prop06SettlementSpot = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 71));
                    Prop07SettlementAuction = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 73));
                    Prop08CompetitorPeriod = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 75));
                    Prop09SolicatorPeriod = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 77));
                    Prop10WarningPercent = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 79));
                    Prop11VolumneFreezePercent = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 81));
                    Prop12SnapQuoteTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 83));
                    Prop13Reserved = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 85));
                    Prop14BroadLotQty = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 87));
                    Prop15TickSize = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 91));
                    Prop16MaxGtcDate = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 95));
                    Prop17StockEligibilty.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 97, 2));
                    Prop18DisClosedQtyPerAllowed = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 99));
                    Prop19RiskFreeIntRate = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 101));
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        /// <summary>
        /// Update Local Database Request : size(82) Location(0-81)
        /// New Structure: Done by Rahul Date:1/11/2010   Size=80-82
        /// </summary>
        public struct UpdateLocalDB : IStruct
        {
            /*
             * Messagestructure             40  40
             * LastUpdateSecurityTime       4   44  
             * LastUpdateParticipantTime    4   48  
             * LastUpdateInstrumentTime     4   52  
             * LastUpdateIndexTime          4   56
             * RequestForOpenOrders         1   57
             * Reserved                     1   58
             * STRUCT STMARKETSTATUS        8   66
             * STRUCT STEXMARKETSTATUS      8   74
             * STRUCT STPLMARKETSTATUS      8   82
             * ============================================
             * Total                        82
             * ============================================
             */
            /// <summary>
            /// STRUCT MESSAGEHEADER : Size(40) Location(0-39)
            /// </summary>
            public MessageHeader strHeader;
            /// <summary>
            /// STRUCT MESSAGEHEADER : Size(40) Location(0-39)
            ...
            /// <summary>
            /// LONG LastUpdateSecurityTime : Size(4) Location(40-43)
            ...
            /// <summary>
            /// LONG LastUpdateParticipantTime : Size(4) Location(44-47)
            /// =0 For Complete Download 
            /// </summary>
            ...
            /// <summary>
            ///  LONG LastUpdateInstrumentTime : Size(4) Location(48-51)
            /// </summary>
            public Int32 iLastUpdInstrumentTime;
            /// <summary>
            ///  LONG LastUpdateParticipantTime : Size(4) Location(48-51)
            /// </summary>
            ...
            /// <summary>
            ///  LONG LastUpdateIndexTime : Size(4) Location(52-55)
            /// </summary>
            ...
            /// <summary>
            /// CHAR RequestForOpenOrders : size(1)  Location(56)
            ...
            /// <summary>
            /// CHAR Reserved : size(1) Location(57)
            /// </summary>
            ...
            /// <summary>
            /// STRUCT STMARKETSTATUS : size(8) Location(59-65)
            /// </summary>
            ...
            /// <summary>
            /// STRUCT STEXMARKETSTATUS : size(8) Location(66-73)
            /// </summary>
            ...
            /// <summary>
            /// STRUCT STPLMARKETSTATUS : size(8) Location(74-81)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, DbHeader, 0, 40);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastUpdSecurityTime), 0, DbHeader, 40, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastUpdParticipantTime), 0, DbHeader, 44, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastUpdInstrumentTime), 0, DbHeader, 48, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastUpdIndextime), 0, DbHeader, 52, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cRequestForOpenOrder), 0, DbHeader, 56, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserved), 0, DbHeader, 57, 1);
                    Buffer.BlockCopy(strLocalDbStatus.StructToByte(), 0, DbHeader, 58, 8);
                    Buffer.BlockCopy(strLocalDbExStatus.StructToByte(), 0, DbHeader, 66, 8);
                    Buffer.BlockCopy(strLocalDbPlStatus.StructToByte(), 0, DbHeader, 74, 8);
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02LastUpdSecurityTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 40));
                    Prop03LastParticipantTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 44));
                    Prop04LastUpdInstrumentTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 48));
                    Prop05LastUpdIndexTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 52));
                    Prop06RequestForOpenOrder = Encoding.ASCII.GetString(ByteStructure, 56, 1);
                    Prop07Reserved = Encoding.ASCII.GetString(ByteStructure, 57, 1);
                    Prop08LocalDbStatus.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 58, 8));
                    Prop09LocalDbExStatus.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 66, 8));
                    Prop10LocalDbPlStatus.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 74, 8));
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        /// <summary>
        /// Local Database header : size(42) Location (0-41)
        /// New Structure: Done by Rahul Date:1/11/2010   Size=40-42
        /// </summary>
        /*
         * MESSAGEHEADER       :        40
           CHAR Reserved [2]    :        2
        ...
        public struct DownloadDbHeader : IStruct
        {
            ...
            MessageHeader strHeader;
            /// <summary>
            /// Message Header : size(40) locayion(0-39)
            ...
            /// <summary>
            /// CHAR Reserved [2] :Size(2) Location(40-41)
            /// </summary>
            char[] cReserve;
            /// <summary>
            /// CHAR Reserved [2] :Size(2) Location(40-41)
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, dloadheader, 0, 40);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve), 0, dloadheader, 40, 2);
                    return dloadheader;
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02Reserve = Encoding.ASCII.GetString(ByteStructure, 40, 2);
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        /// New Structure: Done by Rahul Date:1/11/2010  
        /// </summary>
        /*
         * MESSAGEHEADER             :        40
           CHAR Reserved [432+40]    :        474
         * -----------------------------------------
         *  Total               :              512
         * -----------------------------------------
         */
        public struct DownloadDbData : IStruct
        {
            ...
            Byte[] bData;
            /// <summary>
            /// CHAR Data [472] :Size(472) Location(40-511)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, dloaddata, 0, 40);
        ...
        /// <summary>
        /// Message Download Request : size(48) location(0-47)
        /// Done by Rahul 11/11/2010 
        /// </summary>
        public struct MessageDownloadRequest : IStruct
        {
            ...
            /// <summary>
            /// Double Sequence Number : size(8) location(40-47)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, msgdloadheader, 0, 40);
                    Buffer.BlockCopy(CUtility.HostToNetworkLong(iSequenceNo), 0, msgdloadheader, 40, 8);
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02SequenceNo = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 40, 8));
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        public struct DownloadIndex : IStruct
        {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02NoOfRecords = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 40));
        ...
        /// New Structure : Done by Rahul Date: 1/11/2010  42-44
        /// </summary>
        /// 
        /*
         * MESSAGEHEADER       :        40
        ...
        public struct ExchangePortfolioRequest : IStruct
        {
            ...
            /// <summary>
            /// LastUpdateDtTime        : Size(4)   Location(40-43)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, bExchPortfolioReq, 0, 40);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastUpdateDtTime), 0, bExchPortfolioReq, 40, 4);
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02LastUpdateDtTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 40));
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        ///                               44+285=327
        /// New Structure: Done by Rahul Date1/11/2010                                  
        ///                               44+300=344
        /// </summary>
        /*
         * MESSAGEHEADER            :        40     40
           SHORT NoOfRecords        :        2      42
         * CHAR MoreRecords         :        1      43
         * CHAR Filler              :        1      44
        ...
        public struct ExchangePortfolioResponse : IStruct
        {
            ...
            /// <summary>
            ///  SHORT NoOfRecords        : size(2)   Location(40-41)
            /// </summary>
            Int16 iNoOfRecords;
            /// <summary>
            ///SHORT NoOfRecords        : size(2)   Location(40-41)
            ...
            /// <summary>
            /// CHAR MoreRecords         :size(1) Location(42)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Filler              : size(1) Location(43)
            /// </summary>
            public char[] CFiller;
            /// <summary>
            /// CHAR Filler              : size(1) Location(43)
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                try
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02NoOfRecords = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 40));
                    Prop03MoreRecords = Encoding.ASCII.GetString(ByteStructure, 42, 1);
                    Prop04Filler = Encoding.ASCII.GetString(ByteStructure, 43, 1);
                    for (int idx = 0; idx < Prop02NoOfRecords; idx++)
                    {
                        PortFolioData strportfoliodata = new PortFolioData(0);
                        strportfoliodata.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 44 + (idx * 19), 19));
        ...
        /// New Structure : Done Rahul  Date: 1/11/2010   76-512 To 80-512
        /// </summary>
        public struct ResponseData : IStruct
        {
            ...
            /// <summary>
            /// Message Header :size(40) Location(40-77)
            /// </summary>
            public byte[] bdata;
            /// <summary>
            /// Data :size(max=474) Location(40-511)
            /// </summary>
            public Byte[] Prop02Data
            {
                get { return bdata; }
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                try
                {
                    ...
                    Array.Resize(ref bdata, ByteStructure.Length - CConstants.MsgHeaderSize);
                    Array.Copy(ByteStructure, 40, bdata, 0, ByteStructure.Length - CConstants.MsgHeaderSize);
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        /// <summary>
        /// Signoff Out: Size(185) Location(0-189)
        /// New Structure: Done by Rahul Date:1/11/2010   Size:189
        /// </summary>
        public struct SignOffOut : IStruct
        {
            ...
            /// <summary>
            /// Reserve: Size(145) Location(42-189)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, Lofoff, 0, 40);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iUserId), 0, Lofoff, 40, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve), 0, Lofoff, 44, 145);
                    return Lofoff;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02UserId = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 40));
                    Prop03Reserve = Encoding.ASCII.GetString(ByteStructure, 44, 145);
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        /// <summary>
        /// Order Entry Request : Size(240) Location (0-239)
        /// New Structure : Done by Rahul  Date: 2/11/2010   (Size-240)
        /// </summary>
        public struct OrderEntryRequest : IStruct
        {
            /*
             *  MESSAGEHEADER                      40       40
                CHAR ParticipantType                1       41
                CHAR Reserved                       1       42  
                SHORT CompetitorPeriod              2       44
                SHORT SolicitorPeriod               2       46
                CHAR Modified / CancelledBy         1       47
                CHAR Reserved                       1       48
                SHORT ReasonCode                    2       50
                CHAR Reserved [4]                   4       54
                LONG TokenNo                        4       58
                STRUCT CONTRACTDESC                28       86
                CHAR CounterPartyBrokerId [5]       5       91
                CHAR Reserved                       1       92
                CHAR Reserved [2]                   2       94 
                CHAR CloseoutFlag                   1       95
                CHAR Reserved                       1       96
                SHORT OrderType                     2       98
                DOUBLE OrderNumber                  8       106
                CHAR AccountNumber [10]             10      116
                SHORT BookType                      2       118
                SHORT Buy / SellIndicator           2       120
                LONG DisclosedVolume                4       124
                LONG DisclosedVolumeRemaining       4       128
                LONG TotalVolumeRemaining           4       132
                LONG Volume                         4       136
                LONG VolumeFilledToday              4       140
                LONG Price                          4       144
                LONG TriggerPrice                   4       148
                LONG GoodTillDate                   4       152 
                LONG EntryDateTime                  4       156 
                LONG MinimumFill / AONVolume        4       160
                LONG LastModified                   4       164
                STORDERFLAGS                        2       166
                SHORT BranchId                      2       168
                LONG TraderId                       4       172
                CHAR BrokerId [5]                   5       177
                CHAR Remarks [24]                   24      201
                CHAR Open/Close                     1       202
                CHAR Settlor [12]                   12      214
                SHORT Pro / ClientIndicator         2       216
                SHORT SettlementPeriod              2       218
                CHAR Cover/Uncover                  1       219
                CHAR GiveupFlag                     1       220
                USHORT filler1 :1
                USHORT filler2 :1
                USHORT filler3 :1
                USHORT filler4 :1
                ...
                USHORT filler14 :1
                USHORT filler15 :1
                USHORT filler16 :1                  2       222
                CHAR filler17                       1       223
                CHAR filler18                       1       224
                DOUBLE NnfField                     8       232
                DOUBLE MktReplay                    8       240
             * =====================================================
             * Total                                240     240
             * =====================================================
            */
            ...
            public MessageHeader strHeader;
            /// <summary>
            ///  Property 01 Message Header : Size(40) Loaction(0-39)
            /// </summary>
            public MessageHeader Prop01Header
            {
                get { return strHeader; }
            ...
            /// <summary>
            /// CHAR ParticipantType : size(1) Location(40)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Reserved : size(1) Location(41)
            /// </summary>
            public char[] cReserve;
            /// <summary>
            /// CHAR Reserved : size(1) Location(41)
            ...
            /// <summary>
            /// SHORT CompetitorPeriod : Size(2) Loaction(42-43)
            /// </summary>
            ...
            /// <summary>
            /// SHORT SolicitorPeriod :size(2) Loaction(44-45)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Modified / CancelledBy : size(1) Location(46)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Reserved :size(1) Location(47)
            /// </summary>
            ...
            /// <summary>
            /// SHORT ReasonCode :Size(2) Loaction(48-49)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Reserved [4] :Size(4) Location(50-53)
            /// </summary>
            ...
            /// <summary>
            /// LONG TokenNo : Size(4) Loaction(54-57)
            /// </summary>
            public Int32 iTokenNo;
            /// <summary>
            /// LONG TokenNo : Size(4) Loaction(55-57)
            /// </summary>
            ...
            /// <summary>
            /// CONTRACTDESC :Size(28) Location(85)
            /// </summary>
            ...
            /// <summary>
            /// CHAR CounterPartyBrokerId [5] : Size(5) Location(86-90)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Reserved [2] : size(2) Location(92-93)
            /// </summary>
            ...
            /// <summary>
            /// CHAR CloseoutFlag :Size(1) Location(94)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Reserved : size(1) Location(95)
            /// </summary>
            ...
            /// <summary>
            ///  SHORT OrderType : size(2) Loaction(96-97)
            /// </summary>
            ...
            /// <summary>
            /// DOUBLE OrderNumber :size(8) Location(98-105)
            /// </summary>
            ...
            /// <summary>
            /// CHAR AccountNumber [10]: size(10) Location(106-115)
            /// </summary>
            ...
            /// <summary>
            /// SHORT BookType: size(2) Location(116-117)
            /// </summary>
            ...
            /// <summary>
            /// SHORT Buy / SellIndicator: size(2) Location(118-119)
            /// </summary>
            ...
            /// <summary>
            /// LONG DisclosedVolume : size(4) Location(120-123)
            /// </summary>
            ...
            /// <summary>
            /// LONG DisclosedVolumeRemaining : size(4) location(124-127)
            /// </summary>
            ...
            /// <summary>
            /// LONG TotalVolumeRemaining : size(4) location(128-131)
            /// </summary>
            ...
            /// <summary>
            /// LONG Volume : size(4) location(132-135)
            /// </summary>
            ...
            /// <summary>
            /// LONG VolumeFilledToday : size(4) Location(136-139)
            /// </summary>
            ...
            /// <summary>
            /// LONG Price :size(4) Location(140-143)
            /// </summary>
            public Int32 iPrice;
            /// <summary>
            /// LONG Price :size(4) Location(140-143)
            ...
            /// <summary>
            /// LONG TriggerPrice: Size(4) Location(144-147)
            /// </summary>
            ...
            /// <summary>
            /// LONG GoodTillDate : Size(4) Location(148-151)
            /// </summary>
            ...
            /// <summary>
            /// LONG EntryDateTime: :Size(4) Location(152-155)
            /// </summary>
            ...
            /// <summary>
            /// LONG MinimumFill / AONVolume: size(4) Loaction(156-159)
            /// </summary>
            ...
            /// <summary>
            /// LONG LastModified : size(4) location(160-163)
            /// </summary>
            ...
            /// <summary>
            /// SHORT iflag : size(2)  location(164-165)
            /// </summary>
            public Int16 iflag;
            /// <summary>
            /// SHORT iflag : size(2)  location(164-165)
            ...
            /// <summary>
            /// SHORT BranchId : size(2) Location(166-167)
            /// </summary>
            ...
            /// <summary>
            /// LONG TraderId: Size(4) Location(168-171)
            /// </summary>
            public Int32 iTraderId;
            /// <summary>
            /// SHORT TraderId: Size(4) Location(168-171)
            /// Changes by Rahul   Date:2/11/2010
            /// </summary>
            public Int32 Prop35TraderId
            {
            ...
            /// <summary>
            /// CHAR BrokerId [5] : size(5) Location(172-176)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Remarks [24] : Size(24) Location (177-201)
            /// </summary>
            public char[] cRemark;
            /// <summary>
            /// CHAR Remarks [24] : Size(24) Location (177-200) 
            /// </summary>
            ...
            /// <summary>
            /// CHAR Open/Close : size(1) Location(201)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Settlor [12] : size(12) location(202-213)
            /// </summary>
            ...
            /// <summary>
            /// SHORT Pro / ClientIndicator : size(2) Location(214-215)
            /// </summary>
            ...
            /// <summary>
            /// SHORT SettlementPeriod : size(2) Location(216-217)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Cover/Uncover : size(1) Location(218)
            /// </summary>
            ...
            /// <summary>
            /// CHAR GiveupFlag : size(1) Location(219)
            /// </summary>
            ...
            /// <summary>
            /// LONG OrderID : size(4) Location(220-223)
            /// </summary>
            ...
            /// <summary>
            /// DOUBLE NnfField : size(8) Location(224-231)
            /// </summary>
            ...
            /// <summary>
            /// DOUBLE MktReplay : size(8) Location(232-240)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, OrderRequest, 0, 40);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cParticipantType), 0, OrderRequest, 40, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve), 0, OrderRequest, 41, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iCompetitorPeriod), 0, OrderRequest, 42, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iSolicitorPeriod), 0, OrderRequest, 44, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cModified), 0, OrderRequest, 46, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve1), 0, OrderRequest, 47, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iReasonCode), 0, OrderRequest, 48, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve2), 0, OrderRequest, 50, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTokenNo), 0, OrderRequest, 54, 4);
                    Buffer.BlockCopy(strContractDesc.StructToByte(), 0, OrderRequest, 58, 28);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cCounterBrokerid), 0, OrderRequest, 86, 5);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve3), 0, OrderRequest, 91, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve4), 0, OrderRequest, 92, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cClosedOutFlag), 0, OrderRequest, 94, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserve5), 0, OrderRequest, 95, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iOrderType), 0, OrderRequest, 96, 2);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iOrderNumber), 0, OrderRequest, 98, 8);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cAccountNo), 0, OrderRequest, 106, 10);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(ibookType), 0, OrderRequest, 116, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iIndicator), 0, OrderRequest, 118, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iDisclosedVolume), 0, OrderRequest, 120, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iDisclosedVolRemain), 0, OrderRequest, 124, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTotalVolumeRem), 0, OrderRequest, 128, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iVolume), 0, OrderRequest, 132, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iVolumeFillToday), 0, OrderRequest, 136, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iPrice), 0, OrderRequest, 140, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTriggerPrice), 0, OrderRequest, 144, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iGoodTillDate), 0, OrderRequest, 148, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iEntryDateTime), 0, OrderRequest, 152, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iMinFillVol), 0, OrderRequest, 156, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastModified), 0, OrderRequest, 160, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iflag), 0, OrderRequest, 164, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBranchId), 0, OrderRequest, 166, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTraderId), 0, OrderRequest, 168, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBrokerId), 0, OrderRequest, 172, 5);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cRemark), 0, OrderRequest, 177, 24);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOpenClose), 0, OrderRequest, 201, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSettlor), 0, OrderRequest, 202, 12);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iProIndicator), 0, OrderRequest, 214, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iSettlePeriod), 0, OrderRequest, 216, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cCoverUncover), 0, OrderRequest, 218, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cGiveUpFlag), 0, OrderRequest, 219, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iOrderId), 0, OrderRequest, 220, 4);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iNNFField), 0, OrderRequest, 224, 8);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iMarketReplay), 0, OrderRequest, 232, 8);
                    return OrderRequest;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02ParticipantType = Encoding.ASCII.GetString(ByteStructure, 40, 1);
                    Prop03Reserve = Encoding.ASCII.GetString(ByteStructure, 41, 1);
                    Prop04CompetitionPeriod = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 42));
                    Prop05SolicitorPeriod = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 44));
                    Prop06Modified = Encoding.ASCII.GetString(ByteStructure, 46, 1);
                    Prop07Reserve1 = Encoding.ASCII.GetString(ByteStructure, 47, 1);
                    Prop08ReasonCode = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 48));
                    Prop09Reserve2 = Encoding.ASCII.GetString(ByteStructure, 50, 4);
                    Prop10TokenNo = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 54));
                    strContractDesc.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 58, 28));
                    Prop11ContractDesc = strContractDesc;//.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 56, 28));
                    Prop12CounterBrokerid = Encoding.ASCII.GetString(ByteStructure, 86, 5);
                    Prop13Reserve3 = Encoding.ASCII.GetString(ByteStructure, 91, 1);
                    Prop14Reserve4 = Encoding.ASCII.GetString(ByteStructure, 92, 2);
                    Prop15ClosedoutFlag = Encoding.ASCII.GetString(ByteStructure, 94, 1);
                    Prop16Reserve5 = Encoding.ASCII.GetString(ByteStructure, 95, 1);
                    Prop17OrderType = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 96));
                    Prop18OrderNumber = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 98, 8));//IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 96));
                    Prop19AccountNo = Encoding.ASCII.GetString(ByteStructure, 106, 10);
                    Prop20BookType = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 118));
                    Prop21Indicator = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 118));
                    Prop22DisclosedVolume = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 120));
                    Prop23DisclosedVolRemain = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 124));
                    Prop24TotalVolRemaining = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 128));
                    Prop25Volume = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 132));
                    Prop26VolumeFillToday = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 136));
                    Prop27Price = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 140));
                    Prop28TriggerPrice = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 144));
                    Prop29Goodtilldate = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 148));
                    Prop30EntryDatetime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 152));
                    Prop31MinimumfillVol = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 156));
                    Prop32LastModify = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 160));
                    Prop33OrderFlag = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 164));
                    Prop34BranchId = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 166));
                    Prop35TraderId = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 168));
                    Prop36BrokerId = Encoding.ASCII.GetString(ByteStructure, 172, 5);
                    Prop37Remark = Encoding.ASCII.GetString(ByteStructure, 177, 24);
                    Prop38OpenClose = Encoding.ASCII.GetString(ByteStructure, 201, 1);
                    Prop39Settlor = Encoding.ASCII.GetString(ByteStructure, 202, 12);
                    Prop40ProIndicator = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 214));
                    Prop41SettlementPeriod = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 216));
                    Prop42CoverUncover = Encoding.ASCII.GetString(ByteStructure, 218, 1);
                    Prop43GiveupFlag = Encoding.ASCII.GetString(ByteStructure, 219, 1);
                    PropOrderId = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 220));
                    Prop47NNFField = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 224, 8));//IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 220));
                    Prop48MktReplay = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 232, 8));//IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 228));
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
                ...
                try
                {
                    return (Prop01Header.ToString() + CConstants.Seperator +
                        ...
                        Prop05SolicitorPeriod.ToString() + CConstants.Seperator +
                            ...
                            Convert.ToInt64(Prop18OrderNumber).ToString() + CConstants.Seperator +
        ...
        /// <summary>
        /// Trade Modification Request : size(150) Location (0-153) 
        /// New Structure: Added by Rahul  Date:12/11/2010
        /// </summary>
        public struct TradeModificationRequest : IStruct
        {
            /*
                         *  MESSAGEHEADER                      40           40  
                            LONG TokenNo                        4           44
                            STRUCT CONTRACTDESC                28           72
                            LONG FillNumber                     4           76
                            LONG FillQuantity                   4           80
                            LONG FillPrice                      4           84
                            CHAR MktType                        1           85
                            CHAR BuyOpenClose                   1           86
                            LONG NewVolume                      4           90
                            CHAR BuyBrokerId [5]                5           95
                            CHAR SellBrokerId [5]               5           100
                            LONG TraderId                       4           104
                            CHAR RequestedBy                    1           105                
                            CHAR SellOpenClose                  1           106
                            CHAR BuyAccountNumber [10]          10          116
                            CHAR SellAccountNumber [10]         10          126
                            CHAR BuyParticipant [12]            12          138
                            CHAR SellParticipant [12]           12          150
                            CHAR BuyCoverUncover                1           151
                            CHAR SellCoverUncover               1           152
                            CHAR BuyGiveupFlag                  1           153
                            CHAR SellGiveupFlag                 1           154
             *              =====================================================
             *              Total                                           154    
             *              =====================================================
             */
            ...
            /// <summary>
            /// LONG TokenNo            size(4)     Location(40-45) 
            /// </summary>
            Int32 iTokenNo;
            /// <summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, Tradeinqdata, 0, 40);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTokenNo), 0, Tradeinqdata, 40, 4);
                    Buffer.BlockCopy(strContractDesc.StructToByte(), 0, Tradeinqdata, 44, 28);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iFillNo), 0, Tradeinqdata, 72, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iFillQty), 0, Tradeinqdata, 76, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iFillPrice), 0, Tradeinqdata, 80, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cMarketType), 0, Tradeinqdata, 84, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBuyOpenClose), 0, Tradeinqdata, 85, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iNewVolume), 0, Tradeinqdata, 86, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBuyBrokerid), 0, Tradeinqdata, 90, 5);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSellBrokerid), 0, Tradeinqdata, 95, 5);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTraderId), 0, Tradeinqdata, 100, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cRequestedBy), 0, Tradeinqdata, 104, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSellOpenClose), 0, Tradeinqdata, 105, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBuyAccountNo), 0, Tradeinqdata, 106, 10);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSellAccountNo), 0, Tradeinqdata, 116, 10);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBuyParticipant), 0, Tradeinqdata, 126, 12);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSellParticipant), 0, Tradeinqdata, 138, 12);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBuyCovUncov), 0, Tradeinqdata, 150, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSellCovUncov), 0, Tradeinqdata, 151, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBuyGiveup), 0, Tradeinqdata, 152, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSellGiveup), 0, Tradeinqdata, 153, 1);
                    return Tradeinqdata;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                try
                {
                    ...
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02TokenNumber = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 40));
                    Prop03ContractDesc.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 44, 28));
                    Prop04FillNumber = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 72));
                    Prop05FillQuantity = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 76));
                    Prop06FillPrice = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 80));
                    Prop07MktType = Encoding.ASCII.GetString(ByteStructure, 84, 1);
                    Prop08BuyOpenClose = Encoding.ASCII.GetString(ByteStructure, 85, 1);
                    Prop09NewVolume = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 86));
                    Prop10BuyBrokerId = Encoding.ASCII.GetString(ByteStructure, 90, 5);
                    Prop11SellBrokerId = Encoding.ASCII.GetString(ByteStructure, 95, 5);
                    Prop12TraderId = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 100));
                    Prop13RequestedBy = Encoding.ASCII.GetString(ByteStructure, 104, 1);
                    Prop14SellOpenClose = Encoding.ASCII.GetString(ByteStructure, 105, 1);
                    Prop15BuyAccountNo = Encoding.ASCII.GetString(ByteStructure, 106, 10);
                    Prop16SellAccountNo = Encoding.ASCII.GetString(ByteStructure, 116, 10); ;
                    Prop17BuyParticipant = Encoding.ASCII.GetString(ByteStructure, 126, 12);
                    Prop18SellParticipant = Encoding.ASCII.GetString(ByteStructure, 138, 12);
                    Prop19BuyCoverUncover = Encoding.ASCII.GetString(ByteStructure, 150, 1);
                    Prop20SellCoverUncover = Encoding.ASCII.GetString(ByteStructure, 151, 1);
                    Prop21BuyGiveUpFlag = Encoding.ASCII.GetString(ByteStructure, 152, 1);
                    Prop22SellGiveUpFlag = Encoding.ASCII.GetString(ByteStructure, 153, 1);
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        /// <summary>
        /// New Structure : Done by Rahul   Date: 2/11/2010    400-404
        /// </summary>
        public struct SpreadOrderRequest : IStruct
        {
            /*
                    struct MESSAGEHEADER Header1           40   40
                    CHAR ParticipantType1                   1   41
                    CHAR Filler1                            1   42
                    SHORT CompetitorPeriod1                 2   44
                    SHORT SolicitorPeriod1                  2   46
                    CHAR ModCxlBy1                          1   47
                    CHAR Filler9                            1   48    
                    SHORT ReasonCode1                       2   50
                    CHAR StartAlpha1[2]                     2   52
                    CHAR EndAlpha1[2]                       2   54
                    LONG Token1                             4   58    
                    struct CONTRACTDESC                    28   86
                    CHAR OpBrokerId1 [5]                    5   91 
                    CHAR Fillerx1                           1   92
                    CHAR FillerOptions1[3]                  3   95
                    CHAR Fillery1                           1   96
                    SHORT OrderType1                        2   98
                    DOUBLE OrderNumber1                     8   106
                    CHAR AccountNumber1 [10]                10  116
                    SHORT BookType1                         2   118
                    SHORT BuySell1                          2   120
                    LONG DisclosedVol1                      4   124
                    LONG DisclosedVolRemaining1             4   128
                    LONG TotalVolRemaining1                 4   132
                    LONG Volume1                            4   136
                    LONG VolumeFilledToday1                 4   140
                    LONG Price1                             4   144 
                    LONG TriggerPrice1                      4   148
                    LONG GoodTillDate1                      4   152
                    LONG EntryDateTime1                     4   156
                    LONG MinFillAon1                        4   160
                    LONG LastModified1                      4   164
             *      struct STORDERFLAGS                     2   166
                    SHORT BranchId1                         2   168
                    SHORT TraderId1                         4   172
                    CHAR BrokerId1 [5]                      5   177
                    CHAR OERemarks1 [24]                    24  201
                    CHAR OpenClose1                         1   202
                    CHAR Settlor1 [12]                      12  214
                    SHORT ProClient1                        2   216
                    SHORT SettlementPeriod1                 2   218
                    CHAR CoverUncover1                      1   219
                    CHAR GiveupFlag1                        1   220
                    OrderFiller                             2   222
                    CHAR filler17                           1   223
                    CHAR filler18                           1   224
                    DOUBLE NnfField                         8   232
                    DOUBLE MktReplay                        8   240
                    LONG PriceDiff                          4   248
                 *  struct LegInfo                          80  324
                 *  struct LegInfo                          80  404
                 * =======================================================
                 *  Total                                   404 404
                 *======================================================== 
                ...
                */
            /// <summary>
            ///struct MESSAGEHEADER Header1      size(40) Location(0-39)
            /// </summary>
            public MessageHeader strHeader;
            /// <summary>
            /// struct MESSAGEHEADER Header1      size(40) Location(0-39)
            ...
            /// <summary>
            /// CHAR ParticipantType1:Size(1)  Location(40)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Filler1  : Size(1) Location(41)
            /// </summary>
            public char[] cFiller1;
            /// <summary>
            /// CHAR Filler1  : Size(1) Location(41)
            ...
            /// <summary>
            /// SHORT CompetitorPeriod1 :size(2) Location(42-43)
            /// </summary>
            ...
            /// <summary>
            /// SHORT SolicitorPeriod :size(2) location(44-45)
            /// </summary>
            ...
            /// <summary>
            /// CHAR ModCxlBy1: size(1) Location(46)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Filler9 Size(1) Location(47)
            /// </summary>
            ...
            /// <summary>
            /// SHORT ReasonCode1 Size(2) Location(48-49)
            /// </summary>
            ...
            /// <summary>
            /// CHAR StartAlpha1[2] Size(2) Location(50-51)
            /// </summary>
            ...
            /// <summary>
            /// CHAR EndAlpha1[2] : Size(2) Location(52-53)
            /// </summary>
            ...
            /// <summary>
            /// LONG Token1 Size(4) Location(54-57)
            /// </summary>
            ...
            /// <summary>
            /// struct CONTRACTDESC Size(28) Location(58-85)
            /// </summary>
            public CONTRACTDESC strContractDesc;
            /// <summary>
            /// struct CONTRACTDESC Size(28) Location(58-85)
            ...
            /// <summary>
            /// CHAR OpBrokerId1 [5] Size(5) Location(86-90)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Fillerx1 : Size(1) Location(91)
            /// </summary>
            ...
            /// <summary>
            /// CHAR FillerOptions1[3] :Size(3) Location(92-94)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Fillery1 : Size(1) Location(95)
            /// </summary>
            ...
            /// <summary>
            /// SHORT OrderType1 : size(2) Location(96-97)
            /// </summary>
            ...
            /// <summary>
            /// DOUBLE OrderNumber1 : Size(8) Location(98-105)
            /// </summary>
            ...
            /// <summary>
            /// CHAR AccountNumber1 [10]: size(10) Location(106-115)
            /// </summary>
            ...
            /// <summary>
            /// SHORT BookType1: size(2) Location(116-117)
            /// </summary>
            ...
            /// <summary>
            /// SHORT BuySell1 Size(2) Location(118-119)
            /// </summary>
            ...
            /// <summary>
            /// LONG DisclosedVol1 size(4) Location(120-123)
            /// </summary>
            ...
            /// <summary>
            /// LONG DisclosedVolRemaining1 size(4) Location(124-127)
            /// </summary>
            ...
            /// <summary>
            /// LONG TotalVolRemaining1 Size(4) Location(128-131)
            /// </summary>
            ...
            /// <summary>
            /// LONG Volume1 Size(4) Location(132-135)
            /// </summary>
            ...
            /// <summary>
            /// LONG VolumeFilledToday1 : Size(4) Location(136-139)
            /// </summary>
            ...
            /// <summary>
            /// LONG Price1 : Size(4) Location(140-143)
            /// </summary>
            ...
            /// <summary>
            /// LONG TriggerPrice1 : size(4) Location(144-147)
            /// </summary>
            ...
            /// <summary>
            /// LONG GoodTillDate1 Size(4) Location(149-152)
            /// </summary>
            ...
            /// <summary>
            /// LONG EntryDateTime1 Size(4) Location(153-156)
            /// </summary>
            ...
            /// <summary>
            /// LONG MinFillAon1 : size(4) location(157-160))
            /// </summary>
            ...
            /// <summary>
            /// LONG LastModified1 : Size(4) Location(161-164)
            /// </summary>
            ...
            /// <summary>
            /// SHORT iFlag :    Size(2)  Location(165-166)
            /// </summary>
            public Int16 iflag;
            /// <summary>
            /// SHORT iFlag :    Size(2)  Location(165-166)
            ...
            /// <summary>
            /// SHORT BranchId1 : Size(2) Location(167-168)
            /// </summary>
            ...
            /// <summary>
            /// SHORT TraderId1 : Size(4) location(169-172)
            /// </summary>
            public Int32 iTraderId1;
            /// <summary>
            /// SHORT TraderId1 : Size(4) location(169-172)
            /// </summary>
            public Int32 Prop35TraderId1
            {
            ...
            /// <summary>
            /// CHAR BrokerId1 [5] : size(5) Location(173-177)
            /// </summary>
            ...
            /// <summary>
            /// CHAR OERemarks1 [24]: size(24) Location(178-201)
            /// </summary>
            ...
            /// <summary>
            /// CHAR OpenClose1 : Size(1) Location(202)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Settlor1 [12] : Size(12) Location(203-214)
            /// </summary>
            ...
            /// <summary>
            /// SHORT ProClient1 : size(2) Location(215-216)
            /// </summary>
            ...
            /// <summary>
            /// SHORT SettlementPeriod1 : size(2) Location(217-218)
            /// </summary>
            ...
            /// <summary>
            /// CHAR CoverUncover1 : size(1) Location(219)
            /// </summary>
            ...
            /// <summary>
            /// CHAR GiveupFlag1 : size(1) Location(220)
            /// </summary>
            ...
            /// <summary>
            /// LONG OrderID : Size(4) Location(321-324)
            /// </summary>
            public Int32 iOrderId;
            public Int32 PropOrderId
            {
            ...
            /// <summary>
            /// DOUBLE NnfField : size(8) Location(225-232)
            /// </summary>
            public Double iNnfField;
            /// <summary>
            /// DOUBLE NnfField : size(8) Location(225-232)
            ...
            /// <summary>
            /// DOUBLE MktReplay: size(8) Location(233-240)
            /// </summary>
            public Double iMarketReplay;
            /// <summary>
            /// DOUBLE MktReplay: size(8) Location(233-240)
            ...
            /// <summary>
            /// LONG PriceDiff size(4) Location(241-244)
            /// </summary>
            ...
            /// <summary>
            /// LEGINFO : size(80) Location(245-323)
            /// </summary>
            ...
            /// <summary>
            /// LEGINFO : size(80) Location(324-403)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, SOrder, 0, 40);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cParticipantType1), 0, SOrder, 40, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cFiller1), 0, SOrder, 41, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iCompetitorPeriod1), 0, SOrder, 42, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iSolicitorPeriod1), 0, SOrder, 44, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cModCxlBy1), 0, SOrder, 46, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cFiller9), 0, SOrder, 47, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iReasonCode1), 0, SOrder, 48, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cStartAlpha1), 0, SOrder, 50, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cEndAlpha1), 0, SOrder, 52, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iToken1), 0, SOrder, 54, 4);
                    Buffer.BlockCopy(strContractDesc.StructToByte(), 0, SOrder, 58, 28);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOpBrokerId1), 0, SOrder, 86, 5);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cFillerx1), 0, SOrder, 91, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cFillerOptions1), 0, SOrder, 92, 3);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cFillery1), 0, SOrder, 95, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iOrderType1), 0, SOrder, 96, 2);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iOrderNumber1), 0, SOrder, 98, 8);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cAccountNumber1), 0, SOrder, 106, 10);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBookType1), 0, SOrder, 116, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBuySell1), 0, SOrder, 118, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iDisclosedVol1), 0, SOrder, 120, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iDisclosedVolRemaining1), 0, SOrder, 124, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTotalVolRemaining1), 0, SOrder, 128, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iVolume1), 0, SOrder, 132, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iVolumeFilledToday1), 0, SOrder, 136, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iPrice1), 0, SOrder, 140, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTriggerPrice1), 0, SOrder, 144, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iGoodTillDate1), 0, SOrder, 148, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iEntryDateTime1), 0, SOrder, 152, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iMinFillAon1), 0, SOrder, 156, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iLastModified1), 0, SOrder, 160, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iflag), 0, SOrder, 164, 2);
                    //Buffer.BlockCopy(strOrderFlag.StructToByte(), 0, SOrder, 162, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBranchId1), 0, SOrder, 166, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTraderId1), 0, SOrder, 168, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBrokerId1), 0, SOrder, 172, 5);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOERemarks1), 0, SOrder, 177, 24);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOpenClose1), 0, SOrder, 201, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cSettlor1), 0, SOrder, 202, 12);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iProClient1), 0, SOrder, 214, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iSettlementPeriod1), 0, SOrder, 216, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cCoverUncover1), 0, SOrder, 218, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cGiveupFlag1), 0, SOrder, 219, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iOrderId), 0, SOrder, 220, 4);
                    ...
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iNnfField), 0, SOrder, 224, 8);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iMarketReplay), 0, SOrder, 232, 8);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iPriceDiff), 0, SOrder, 240, 4);
                    Buffer.BlockCopy(strLeg2.StructToByte(), 0, SOrder, 244, 80);
                    Buffer.BlockCopy(strLeg3.StructToByte(), 0, SOrder, 324, 80);
                    return SOrder;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                try
                {
                    ...
                    prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    prop02ParticipantType1 = Encoding.ASCII.GetString(ByteStructure, 40, 1);
                    Prop03Filler1 = Encoding.ASCII.GetString(ByteStructure, 41, 1);
                    Prop04CompetitorPeriod1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 42));
                    Prop05SolicitorPeriod = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 44));
                    Prop06ModCxlBy1 = Encoding.ASCII.GetString(ByteStructure, 46, 1);
                    Prop07Filler9 = Encoding.ASCII.GetString(ByteStructure, 47, 1);
                    Prop08ReasonCode1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 48));
                    Prop09StartAlpha1 = Encoding.ASCII.GetString(ByteStructure, 50, 2);
                    Prop10EndAlpha1 = Encoding.ASCII.GetString(ByteStructure, 52, 2);
                    Prop11Token1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 54));
                    strContractDesc.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 58, 28));
                    Prop12ContractDesc = strContractDesc;
                    Prop13OpBrokerId1 = Encoding.ASCII.GetString(ByteStructure, 86, 5);
                    Prop14Fillerx1 = Encoding.ASCII.GetString(ByteStructure, 91, 1);
                    Prop15FillerOptions1 = Encoding.ASCII.GetString(ByteStructure, 92, 3);
                    Prop16Fillery1 = Encoding.ASCII.GetString(ByteStructure, 95, 1);
                    Prop17OrderType1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 96));
                    Prop18OrderNumber1 = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 98, 8));//IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 96));
                    Prop19AccountNumber1 = Encoding.ASCII.GetString(ByteStructure, 106, 10);
                    Prop20BookType1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 116));
                    Prop21BuySell1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 118));
                    Prop22DisclosedVol1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 120));
                    Prop23DisclosedVolRemaining = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 124));
                    Prop24TotalVolRemaining1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 128));
                    Prop25Volume1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 132));
                    Prop26VolumeFilledToday1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 136));
                    Prop27Price1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 140));
                    Prop28TriggerPrice1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 144));
                    Prop29GoodTillDate1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 148));
                    Prop30EntryDateTime1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 152));
                    Prop31MinFillAon1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 156));
                    Prop32LastModified1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 160));
                    //Prop33OrderFlag.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 163, 2));
                    Prop33OrderFlag = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 164));
                    Prop34BranchId1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 166));
                    Prop35TraderId1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 168));
                    Prop36BrokerId1 = Encoding.ASCII.GetString(ByteStructure, 172, 5);
                    Prop37OERemarks1 = Encoding.ASCII.GetString(ByteStructure, 177, 24);
                    Prop38OpenClose1 = Encoding.ASCII.GetString(ByteStructure, 201, 1);
                    Prop39Settlor1 = Encoding.ASCII.GetString(ByteStructure, 202, 12);
                    Prop40ProClient1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 214));
                    Prop41SettlementPeriod1 = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 216));
                    Prop42CoverUncover1 = Encoding.ASCII.GetString(ByteStructure, 218, 1);
                    Prop43GiveupFlag1 = Encoding.ASCII.GetString(ByteStructure, 219, 1);
                    PropOrderId = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 220));
                    ...
                    Prop47NnfField = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 224, 8)); //IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 221));
                    Prop48MarketReplay = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 232, 8));//IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 229));
                    Prop49PriceDiff = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 240));
                    strLeg2.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 244, 80));
                    Prop50Leg2 = strLeg2;
                    strLeg3.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 324, 80));
                    Prop51Leg3 = strLeg3;
                }
                catch (Exception ex)
                {
            ...
            public override string ToString()
            {
                try
                {
                    return (prop01Header.ToString() + CConstants.Seperator +
                        ...
                        Convert.ToInt64(Prop18OrderNumber1).ToString() + CConstants.Seperator + Prop19AccountNumber1 + CConstants.Seperator + Prop20BookType1.ToString() + CConstants.Seperator + Prop21BuySell1.ToString() + CConstants.Seperator + Prop22DisclosedVol1.ToString() + CConstants.Seperator + Prop23DisclosedVolRemaining.ToString() + CConstants.Seperator +
        ...
        public struct TapInvitation : IStruct
        {
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    TapInvitation = CUtility.PutBytesInPosition(Prop01Header.StructToByte(), 0, 40, TapInvitation);
                    TapInvitation = CUtility.PutBytesInPosition(CUtility.GetBytesFromNumbers(Prop02Count), 40, 2, TapInvitation);
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02Count = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 40));
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        /// New Structure: Added by Rahul D   Date: 12/11/2010
        /// </summary>
        public struct TradeConfirm : IStruct
        {
            /*
                    MESSAGEHEADER                           40  40
                    DOUBLE ResponseOrderNumber              8   48
                    CHAR BrokerId [5]                       5   53
                    CHAR Reserved                           1   54
                    LONG TraderNumber                       4   58
                    CHAR AccountNumber [10]                 10  68
                    SHORT Buy/SellIndicator                 2   70
                    LONG OriginalVolume                     4   74
                    LONG DisclosedVolume                    4   78
                    LONG RemainingVolume                    4   82
                    LONG DisclosedVolume Remaining          4   86
                    LONG Price                              4   90
                    STRUCT STORDER FLAGS                    2   92
                    LONG GoodTillDate                       4   96  
                    LONG FillNumber                         4   100  
                    LONG FillQuantity                       4   104
                    LONG FillPrice                          4   108
                    LONG VolumeFilledToday                  4   112
                    CHAR ActivityType [2]                   2   114
                    LONG ActivityTime                       4   118
                    DOUBLE CounterTraderOrderNumber         8   126
                    CHAR CounterBrokerId [5]                5   131
                    LONG Token                              4   135
                    STRUCT CONTRACTDESC                     28  163
                    CHAR OpenClose                          1   164
                    CHAR OldOpenClose                       1   165
                    CHAR BookType                           1   166
                    LONG NewVolume                          4   170
                    CHAR OldAccountNumber [10]              10  180
                    CHAR Participant [12]                   12  192
                    CHAR OldParticipant [12]                12  204
                    CHAR CoverUncover                       1   205
                    CHAR OldCoverUncover                    1   206 
                    CHAR GiveUpTrade                        1   207
            */
            /// <summary>
            /// MESSAGEHEADER :size(40) Location(0-39)
            /// </summary>
            ...
            /// <summary>
            /// DOUBLE ResponseOrderNumber : size(8) Location(40-47)
            /// </summary>
            ...
            /// <summary>
            /// CHAR BrokerId [5]       Size(5) Location(48-52)
            /// </summary>
            public char[] cBrokerId;
            /// <summary>
            /// CHAR BrokerId [5]       Size(5) Location(48-52)
            ...
            /// <summary>
            /// CHAR Reserved           Size(1) Location(53)
            /// </summary>
            public char[] cReserved;
            /// <summary>
            /// CHAR Reserved           Size(1) Location(53)
            ...
            /// <summary>
            /// SHORT TraderNumber      Size(4) Location(54-57)
            /// </summary>
            public Int32 iTraderNumber;
            /// <summary>
            /// LONG TraderNumber      Size(4) Location(54-57)
            /// </summary>
            public Int32 prop05TraderNumber
            {
            ...
            /// <summary>
            /// CHAR AccountNumber [10]   Size(10) Location(58-67)
            /// </summary>
            ...
            /// <summary>
            /// SHORT Buy/SellIndicator     size(2) Location(68-69)
            /// </summary>
            ...
            /// <summary>
            /// LONG OriginalVolume : Size(4)   Location(70-71)
            /// </summary>
            ...
            /// <summary>
            /// LONG DisclosedVolume    Size(4) Location(72-75)
            /// </summary>
            public Int32 iDisclosedVolume;
            /// <summary>
            /// LONG DisclosedVolume    Size(4) Location(72-75)
            ...
            /// <summary>
            /// LONG RemainingVolume        Size(4) Location(76-79)
            /// </summary>
            ...
            /// <summary>
            /// LONG DisclosedVolume Remaining      size(4) Location(80-83)
            /// </summary>
            ...
            /// <summary>
            /// LONG Price          size(4)     Location(84-87)
            /// </summary>
            public Int32 iPrice;
            /// <summary>
            /// LONG Price          size(4)     Location(84-87)
            ...
            /// <summary>
            /// SHORT flag  : Size (2)   Location(88-89)
            /// </summary>
            public Int16 iflag;
            ...
            /// <summary>
            /// LONG GoodTillDate       : Size(4) Location(90-93)
            /// </summary>
            public Int32 iGoodTillDate;
            /// <summary>
            /// LONG GoodTillDate       : Size(4) Location(90-93)
            ...
            /// <summary>
            /// LONG FillNumber     Size(4) Location(94-97)
            /// </summary>
            ...
            /// <summary>
            /// LONG FillQuantity       Size(4) Location(98-101)
            /// </summary>
            ...
            /// <summary>
            /// LONG FillPrice          Size(4) location(102-105)
            /// </summary>
            public Int32 iFillPrice;
            /// <summary>
            /// LONG FillPrice          Size(4) location(102-105)
            ...
            /// <summary>
            /// LONG VolumeFilledToday  Size(4) Location(106-109)
            /// </summary>
            ...
            /// <summary>
            /// CHAR ActivityType [2]       Size(2) location(110-111)
            /// </summary>
            ...
            /// <summary>
            /// LONG ActivityTime       Size(4) Location(112-115)
            /// </summary>
            ...
            /// <summary>
            /// DOUBLE CounterTraderOrderNumber :Size(8) location(116-123)
            /// </summary>
            ...
            /// <summary>
            /// CHAR CounterBrokerId [5]        Size(5) Location(124-128)
            /// </summary>
            public char[] cCounterBrokerId;
            /// <summary>
            /// CHAR CounterBrokerId [5]        Size(5) Location(124-128)
            ...
            /// <summary>
            /// LONG Token  Size(4)     Location(129-132)
            /// </summary>
            public Int32 iToken;
            ...
            /// <summary>
            /// STRUCT CONTRACTDESC    Size(28) Location(133-160)
            /// </summary>
            public CONTRACTDESC strContractDesc;
            /// <summary>
            /// STRUCT CONTRACTDESC    Size(28) Location(133-160)
            ...
            /// <summary>
            /// CHAR OpenClose      size(1) Location(161)
            ...
            /// <summary>
            /// CHAR OldOpenClose   Size(1) Location(162)
            /// </summary>
            ...
            /// <summary>
            /// CHAR BookType       Size(1) Location(163)
            ...
            /// <summary>
            /// LONG NewVolume      size(4)     Location(164-167)
            /// </summary>
            public Int32 iNewVolume;
            /// <summary>
            /// LONG NewVolume      size(4)     Location(164-167)
            ...
            /// <summary>
            /// CHAR OldAccountNumber [10]      size(10) location(168-177)
            /// </summary>
            ...
            /// <summary>
            /// CHAR Participant [12]   Size(12) location(178-189)
            /// </summary>
            ...
            /// <summary>
            /// CHAR OldParticipant [12]        size(12)    Location(190-201)
            /// </summary>
            ...
            /// <summary>
            /// CHAR CoverUncover   size(1) Location(202)
            /// </summary>
            public char[] cCoverUncover;
            /// <summary>
            /// CHAR CoverUncover   size(1) Location(202)
            ...
            /// <summary>
            /// CHAR OldCoverUncover        size(1)     Location(203)
            /// </summary>
            ...
            /// <summary>
            /// CHAR GiveUpTrade:       Size(1)     Location(204)
            /// </summary>
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, Tradecon, 0, 40);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iResponseOrderNumber), 0, Tradecon, 40, 8);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBrokerId), 0, Tradecon, 48, 5);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserved), 0, Tradecon, 53, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTraderNumber), 0, Tradecon, 54, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cAccountNumber), 0, Tradecon, 58, 10);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBuySellIndicator), 0, Tradecon, 68, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iOriginalVolume), 0, Tradecon, 70, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iDisclosedVolume), 0, Tradecon, 74, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iRemainingVolume), 0, Tradecon, 78, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iDisclosedVolumeRemaining), 0, Tradecon, 82, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iPrice), 0, Tradecon, 86, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iflag), 0, Tradecon, 90, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iGoodTillDate), 0, Tradecon, 92, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iFillNumber), 0, Tradecon, 96, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iFillQuantity), 0, Tradecon, 100, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iFillPrice), 0, Tradecon, 104, 4);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iVolumeFilledToday), 0, Tradecon, 108, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cActivityType), 0, Tradecon, 112, 2);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iActivityTime), 0, Tradecon, 114, 4);
                    Buffer.BlockCopy(CUtility.HostToNetworkDouble(iCounterTraderOrderNumber), 0, Tradecon, 118, 8);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cCounterBrokerId), 0, Tradecon, 126, 5);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iToken), 0, Tradecon, 131, 4);
                    Buffer.BlockCopy(strContractDesc.StructToByte(), 0, Tradecon, 135, 28);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOpenClose), 0, Tradecon, 163, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOldOpenClose), 0, Tradecon, 164, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBookType), 0, Tradecon, 165, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iNewVolume), 0, Tradecon, 166, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOldAccountNumber), 0, Tradecon, 170, 10);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cParticipant), 0, Tradecon, 180, 12);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOldParticipant), 0, Tradecon, 192, 12);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cCoverUncover), 0, Tradecon, 204, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cOldCoverUncover), 0, Tradecon, 205, 1);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cGiveUpTrade), 0, Tradecon, 206, 1);
                    return Tradecon;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    prop02ResponseOrderNumber = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 40, 8));//IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 38));
                    prop03BrokerId = Encoding.ASCII.GetString(ByteStructure, 48, 5);
                    Prop04Reserved = Encoding.ASCII.GetString(ByteStructure, 53, 1);
                    prop05TraderNumber = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 54));
                    Prop06AccountNumber = Encoding.ASCII.GetString(ByteStructure, 58, 10);
                    Prop07BuySellIndicator = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 68));
                    Prop08OriginalVolume = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 70));
                    Prop09DisclosedVolume = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 74));
                    Prop10RemainingVolume = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 78));
                    Prop11DisclosedVolumeRemaining = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 82));
                    Prop12Price = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 86));
                    Prop13OrderFlag = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 90));
                    Prop14GoodTillDate = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 92));
                    Prop15FillNumber = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 96));
                    Prop16FillQuantity = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 100));
                    Prop17FillPrice = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 104));
                    Prop18VolumeFilledToday = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 108));
                    prop19ActivityType = Encoding.ASCII.GetString(ByteStructure, 112, 2);
                    Prop20ActivityTime = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 114));
                    Prop21CounterTraderOrderNumber = CUtility.NetworkToHostDouble(CUtility.GetByteArrayFromStructure(ByteStructure, 118, 8));//IPAddress.NetworkToHostOrder(BitConverter.ToInt64(ByteStructure, 114));
                    Prop22CounterBrokerId = Encoding.ASCII.GetString(ByteStructure, 126, 5);// 1 byte adjest
                    Prop23Token = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 132));
                    strContractDesc.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 136, 28));
                    Prop24ContractDesc = strContractDesc;
                    Prop25OpenClose = Encoding.ASCII.GetString(ByteStructure, 164, 1);
                    Prop26OldOpenClose = Encoding.ASCII.GetString(ByteStructure, 165, 1);
                    Prop27BookType = Encoding.ASCII.GetString(ByteStructure, 166, 1);
                    Prop28NewVolume = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 167));
                    Prop29OldAccountNumber = Encoding.ASCII.GetString(ByteStructure, 171, 10);
                    Prop30Participant = Encoding.ASCII.GetString(ByteStructure, 181, 12);
                    Prop31OldParticipant = Encoding.ASCII.GetString(ByteStructure, 194, 12);//1 byte adjest
                    Prop32CoverUncover = Encoding.ASCII.GetString(ByteStructure, 206, 1);
                    Prop33OldCoverUncover = Encoding.ASCII.GetString(ByteStructure, 207, 1);
                    Prop34GiveUpTrade = Encoding.ASCII.GetString(ByteStructure, 208, 1);
            ...
            public override string ToString()
            {
                ...
                {
                    return (Prop01Header.ToString() + CConstants.Seperator +
                        Convert.ToInt64(prop02ResponseOrderNumber).ToString() + CConstants.Seperator +
                        ...
                        Prop11DisclosedVolumeRemaining.ToString()+CConstants.Seperator+
                        Prop12Price.ToString() + CConstants.Seperator +
                        Prop13OrderFlag.ToString() + CConstants.Seperator +
                        Prop14GoodTillDate.ToString()+CConstants.Seperator+
                        Prop15FillNumber.ToString()+CConstants.Seperator+
                        Prop16FillQuantity.ToString()+CConstants.Seperator+
                        Prop17FillPrice.ToString()+CConstants.Seperator+
                        Prop18VolumeFilledToday.ToString()+CConstants.Seperator+
                        prop19ActivityType+CConstants.Seperator+
                        Prop20ActivityTime.ToString()+CConstants.Seperator+
                        Prop21CounterTraderOrderNumber.ToString()+CConstants.Seperator+
        ...
        /// <summary>
        /// Done By Rahul 16/11/2010
        /// </summary>
        /*
         *  MESSAGEHEADER                  40       40
            LONG TraderId                   4       44
            CHAR Reserved [3]               3       47
            CHAR Reserved                   1       48
            SHORT BroadCastMessage Length   2       50
            CHAR BroadCastMessage [239]     239     287
         * ================================================
         *  Total                           290     290
         * ================================================
         */
        public struct TraderInteractivemsg : IStruct
        {
            ...
            public byte[] StructToByte()
            {
                ...
                try
                {
                    Buffer.BlockCopy(strHeader.StructToByte(), 0, IntTrader, 0, 40);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iTraderId), 0, IntTrader, 40, 4);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserved), 0, IntTrader, 44, 3);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cReserved1), 0, IntTrader, 47, 1);
                    Buffer.BlockCopy(CUtility.GetBytesFromNumbers(iBroadCastMessageLength), 0, IntTrader, 48, 2);
                    Buffer.BlockCopy(CUtility.ConvertCharFrom16to8bit(cBroadCastMessage), 0, IntTrader, 50, 239);
                    return IntTrader;
                }
                catch (Exception ex)
                {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                {
                    Prop01Header.ByteToStruct(CUtility.GetHeaderFromStructure(ByteStructure));
                    Prop02TraderId = IPAddress.NetworkToHostOrder(BitConverter.ToInt32(ByteStructure, 40));
                    Prop03Reserved = Encoding.ASCII.GetString(ByteStructure, 44, 3);
                    Prop04Reserved1 = Encoding.ASCII.GetString(ByteStructure, 47, 1);
                    Prop05BroadCastMessageLength = IPAddress.NetworkToHostOrder(BitConverter.ToInt16(ByteStructure, 48));
                    Prop06BroadCastMessage = Encoding.ASCII.GetString(ByteStructure, 50, 239);
                }
                catch (Exception ex)
                {
                    FnoCtclLib.Reference.LogException(ex, ex.Source.ToString() + ex.Message + "Trace : " + ex.StackTrace);
        ...
        #region Index Map Table         Transaction Code:7326      size:462
        /// <summary>
        /// New Structure: Index Map Table  460-462
        /// </summary>
        ...
        public struct IndexMapTable : IStruct
        {
            ...
            public void ByteToStruct(byte[] ByteStructure)
            {
                ...
                for (int idx = 0; idx < Prop02NoOfRecords; idx++)
                {
                    ...
                    indexdet.ByteToStruct(CUtility.GetByteArrayFromStructure(ByteStructure, 42 + (idx * 41), 41));
